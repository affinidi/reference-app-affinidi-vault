...
To create a Login Configuration, you can either use [Affinidi CLI](https://github.com/affinidi/affinidi-cli#set-up-affinidi-login-for-your-applications) or at [Affinidi Portal](https://portal.affinidi.com/)
...
`affinidi login create-config --name='Java Springboot Demo Application' --redirect-uris='http://localhost:8080/login/oauth2/code/javademo'`
...
- If you are using Affinidi directly without an identity provider, it should be a URL to your application as shown above
...
```json
{
  ...
  "name": "Java Springboot Demo Application",
  "auth": {
    "clientId": "<CLIENT_ID>",
...
By default Affinidi Login requests an Email VC. To request user profile data update login configuration with instruction provided below.
