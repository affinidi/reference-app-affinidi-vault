...
async function generate() {
  ...
  const frameworkPath = join(generatorPath, frameworkFolderName)
  const overridesPath = join(frameworkPath, 'overrides')
  const templatePath = join(frameworkPath, 'template')
